...
namespace Healthify.Pages
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IBlood_Bindings
        {
            ...
            private void Update_(global::Healthify.Models.Response obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
                    {
                        ...
                        this.Update_Bpos(obj.Bpos, phase);
                        this.Update_Apos(obj.Apos, phase);
                        this.Update_Bneg(obj.Bneg, phase);
                        this.Update_Aneg(obj.Aneg, phase);
                    }
                }
            }
            ...
            private void Update_Bpos(global::System.String obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Apos(global::System.String obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Bneg(global::System.String obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_Aneg(global::System.String obj, int phase)
            {
                if((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
